...
train_cfg = dict(type="EpochBasedTrainLoop", max_epochs=60, val_begin=1, val_interval=3)
...
param_scheduler = [
    ...
    dict(type="CosineAnnealingLR", T_max=60, eta_min=0, by_epoch=True, begin=0, end=60),
]
