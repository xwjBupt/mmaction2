...
ann_file_train = f"/ai/mnt/code/mmaction2/tools/data/AmTICIS/train_C.txt"
ann_file_val = f"/ai/mnt/code/mmaction2/tools/data/AmTICIS/val_C.txt"
ann_file_test = f"/ai/mnt/code/mmaction2/tools/data/AmTICIS/val_C.txt"
