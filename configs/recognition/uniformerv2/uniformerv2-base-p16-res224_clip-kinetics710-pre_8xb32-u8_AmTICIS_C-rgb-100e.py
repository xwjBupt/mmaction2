...
ann_file_train = "/ai/mnt/code/mmaction2/tools/data/AmTICIS/train_C.txt"
ann_file_val = "/ai/mnt/code/mmaction2/tools/data/AmTICIS/val_C.txt"
ann_file_test = "/ai/mnt/code/mmaction2/tools/data/AmTICIS/val_C.txt"
